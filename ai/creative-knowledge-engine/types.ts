...
export enum KnowledgeCreativeDomain {
...
export enum KnowledgeCreativeDirectionStyle {
  Minimal = "minimal",
  Bold = "bold",
  Cinematic = "cinematic",
...
export enum KnowledgeCreativePlatform {
  TikTok = "tiktok",
  Instagram = "instagram",
  Facebook = "facebook",
  YouTube = "youtube",
...
export enum KnowledgeCreativeMarketingGoal {
