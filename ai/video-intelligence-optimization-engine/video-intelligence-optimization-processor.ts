...
export class VideoIntelligenceOptimizationProcessor {
  ...
  constructor(
    ...
    private readonly analyzer: VideoIntelligenceOptimizationAnalyzer,

    private readonly scorer: VideoIntelligenceOptimizationScorer,

    private readonly linker: VideoIntelligenceOptimizationLinker,

    private readonly records: VideoIntelligenceOptimizationRecordStore,

    private readonly logger: VideoIntelligenceOptimizationLogger
  ...
  async runOptimization(input: VideoIntelligenceOptimizationInput): Promise<VideoIntelligenceOptimizationResult> {
    ...
    const draft: VideoIntelligenceOptimizationRecord = {
  ...
  private reject(start: number, message: string, diagnostics: string[]): VideoIntelligenceOptimizationResult {
