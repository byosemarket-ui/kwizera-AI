...
export enum AudioQualityValidationPlatform {
  Website = "website",
  Mobile = "mobile",
  Podcast = "podcast",
  Audiobook = "audiobook",
...
export enum AudioQualityTrackCheck {
...
export enum AudioQualityTimelineCheck {
...
export enum AudioBrandValidationCheck {
...
export enum AudioTechnicalValidationCheck {
  Codec = "codec",
...
export enum AudioQualityIssueSeverity {
  Low = "low",
  Medium = "medium",
  High = "high",
  Critical = "critical",
...
export enum AudioQualityIssueCategory {
...
export const ALL_AUDIO_QUALITY_VALIDATION_PLATFORMS: AudioQualityValidationPlatform[] = Object.values(AudioQualityValidationPlatform);
export const ALL_AUDIO_QUALITY_CHECKS: AudioQualityCheck[] = Object.values(AudioQualityCheck);
export const ALL_AUDIO_QUALITY_TRACK_CHECKS: AudioQualityTrackCheck[] = Object.values(AudioQualityTrackCheck);
export const ALL_AUDIO_QUALITY_TIMELINE_CHECKS: AudioQualityTimelineCheck[] = Object.values(AudioQualityTimelineCheck);
export const ALL_AUDIO_SYNC_CHECKS: AudioSyncCheck[] = Object.values(AudioSyncCheck);
export const ALL_AUDIO_BRAND_VALIDATION_CHECKS: AudioBrandValidationCheck[] = Object.values(AudioBrandValidationCheck);
export const ALL_AUDIO_TECHNICAL_VALIDATION_CHECKS: AudioTechnicalValidationCheck[] = Object.values(AudioTechnicalValidationCheck);

export const AUDIO_QUALITY_PLATFORM_CONFIG: Record<
  AudioQualityValidationPlatform,
  { sampleRate: number; bitDepth: number; loudnessTarget: number; channelLayout: string; codec: string }
> = {
