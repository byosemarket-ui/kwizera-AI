import { ReasoningApproach, ReasoningRequest, ReasoningType } from "./types.js";

const WORKFLOW_BY_TYPE: Partial<Record<ReasoningType, string>> = {
...
export class ApproachGenerator {
  generate(request: ReasoningRequest): ReasoningApproach[] {
