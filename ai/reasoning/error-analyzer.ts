...
export class ErrorAnalyzer {
  analyze(input: ErrorAnalysisInput): ErrorAnalysisResult {
  ...
  private inferRootCause(input: ErrorAnalysisInput): string {
  ...
  private generateRecoveryOptions(input: ErrorAnalysisInput): RecoveryOption[] {
    return [
      {
