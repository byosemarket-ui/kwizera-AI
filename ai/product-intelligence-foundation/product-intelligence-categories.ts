...
export const PREPARED_PRODUCT_INTELLIGENCE_MODULES: PreparedProductIntelligenceModule[] = [
  {
...
export const SUPPORTED_PRODUCT_INTELLIGENCE_SOURCES: ProductIntelligenceSource[] = [
