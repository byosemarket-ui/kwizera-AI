...
import { HealthHistoryEntry, MemoryHealthScoreLevel } from "./types.js";
...
export class HealthHistoryStore {
  ...
  initialize(healthDir: string): void {
    ...
    if (fs.existsSync(this.historyPath)) {
      this.entries = JSON.parse(fs.readFileSync(this.historyPath, "utf8")) as HealthHistoryEntry[];
    }
  }
  ...
  getRecent(count = 10): HealthHistoryEntry[] {
