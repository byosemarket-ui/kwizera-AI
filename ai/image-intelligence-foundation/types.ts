...
export enum ImageIntelligenceLifecycleState {
...
export enum ImageIntelligenceCategory {
...
export enum ImageIntelligenceModuleStatus {
  Prepared = "prepared",
...
export enum ImageIntelligenceHealthLevel {
  Excellent = "excellent",
  Good = "good",
  Warning = "warning",
  Critical = "critical",
...
export enum ImageIntelligenceSource {
...
export enum ImageIntelligenceVerificationStatus {
...
export enum ImageIntelligenceAccessPermission {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
...
export enum ImageIntelligenceAccessOperation {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
