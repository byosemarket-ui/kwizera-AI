...
const REQUIRED_FIELDS: (keyof KnowledgeRecordInput)[] = [
  "knowledgeType",
  "category",
  "title",
  "description",
...
export class KnowledgeRecordValidator {
  validateInput(input: KnowledgeRecordInput): KnowledgeStorageValidationResult {
    ...
    if (
      verification === KnowledgeVerificationStatus.Verified &&
  ...
  validateUpdate(update: KnowledgeRecordUpdate): KnowledgeStorageValidationResult {
    ...
    if (
      update.verificationStatus === KnowledgeVerificationStatus.Verified &&
  ...
  resolveVerificationStatus(
    ...
    requested?: KnowledgeVerificationStatus
  ...
  resolveRecordStatus(
    ...
    requested?: KnowledgeRecordStatus
  ): KnowledgeRecordStatus {
  ...
  computeContentHash(
    record: Pick<
      KnowledgeRecord,
      "title" | "description" | "summary" | "tags" | "keywords" | "payload"
    >
  ): string {
  ...
  buildSearchableText(
    record: Pick<KnowledgeRecord, "title" | "description" | "summary" | "tags" | "keywords" | "category">
  ): string {
