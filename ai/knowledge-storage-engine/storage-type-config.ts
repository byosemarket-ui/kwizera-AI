...
export const KNOWLEDGE_STORAGE_TYPE_DEFINITIONS: KnowledgeStorageTypeDefinition[] = [
...
export function getKnowledgeStorageTypeDefinition(type: KnowledgeStorageType): KnowledgeStorageTypeDefinition {
...
export function mapStorageTypeToFoundationCategory(type: KnowledgeStorageType): KnowledgeCategory {
