...
export class ProductIntelligenceOptimizationProcessor {
  constructor(
    ...
    private readonly analyzer: ProductIntelligenceOptimizationAnalyzer,
    private readonly scorer: ProductIntelligenceOptimizationScorer,
    private readonly linker: ProductIntelligenceOptimizationLinker,
    private readonly records: ProductIntelligenceOptimizationRecordStore,
    private readonly logger: ProductIntelligenceOptimizationLogger
  ) {}
  ...
  async runOptimization(input: ProductIntelligenceOptimizationInput): Promise<ProductIntelligenceOptimizationResult> {
    ...
    const draft: ProductIntelligenceOptimizationRecord = {
      optimizationId: profile.optimizationId,
      productId: input.productId,
  ...
  private reject(start: number, message: string, diagnostics: string[]): ProductIntelligenceOptimizationResult {
