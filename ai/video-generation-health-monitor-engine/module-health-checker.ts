...
export class VideoGenerationModuleHealthChecker {
  ...
  checkAll(): MonitoredVideoGenerationModuleHealthScore[] {
    const scores: MonitoredVideoGenerationModuleHealthScore[] = [];

    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.VideoGenerationFoundation, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.StoryboardGeneration, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.SceneGeneration, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.CameraDirector, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.MotionGeneration, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.Animation, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.VisualEffects, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.AudioSynchronization, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.MarketingVideo, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.VideoProduction, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.RenderingPreparation, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.VideoQualityValidation, () => {
    ...
    scores.push(
      this.checkModule(MonitoredVideoGenerationModule.VideoGenerationOptimization, () => {
  ...
  scoreToLevel(score: number): VideoGenerationHealthScoreLevel {
    if (score >= 95) return VideoGenerationHealthScoreLevel.Excellent;
    if (score >= 80) return VideoGenerationHealthScoreLevel.Good;
    if (score >= 60) return VideoGenerationHealthScoreLevel.Warning;
    if (score >= 40) return VideoGenerationHealthScoreLevel.Critical;
