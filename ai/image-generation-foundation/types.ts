...
export enum ImageGenerationLifecycleState {
...
export enum ImageGenerationCategory {
...
export enum ImageGenerationModuleStatus {
  Prepared = "prepared",
...
export enum ImageGenerationHealthLevel {
  Excellent = "excellent",
  Good = "good",
  Warning = "warning",
  Critical = "critical",
...
export enum ImageGenerationVerificationStatus {
...
export enum ImageGenerationAccessPermission {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
...
export enum ImageGenerationAccessOperation {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
...
export enum ImageGenerationAssetType {
  Prompt = "prompt",
  Image = "image",
...
export enum ImageGenerationBlueprintStage {
...
export enum ImageGenerationWorkflowActionType {
  Generate = "generate",
  Edit = "edit",
  Replace = "replace",
  Sync = "sync",
...
export enum ImageGenerationPlatformTarget {
  Instagram = "instagram",
  Pinterest = "pinterest",
  Facebook = "facebook",
  Website = "website",
...
export enum ImageGenerationResolutionTarget {
  Thumbnail = "thumbnail",
  Standard = "standard",
  High = "high",
  Ultra = "ultra",
