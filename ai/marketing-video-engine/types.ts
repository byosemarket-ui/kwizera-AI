...
export enum MarketingVideoPlanType {
...
export const MARKETING_VIDEO_PLATFORM_TARGETS: StoryboardGenerationPlatform[] = [
...
export const PLATFORM_MARKETING_CONFIG: Record<
  StoryboardGenerationPlatform,
  { hookStyle: string; ctaAdaptation: string }
> = {
