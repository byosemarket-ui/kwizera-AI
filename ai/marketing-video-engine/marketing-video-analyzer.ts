...
import {
  AbTestPreparationPlan,
  CallToActionPlan,
  ConversionOptimizationPlan,
  EngagementOptimizationPlan,
  HookOptimizationPlan,
  MarketingStrategyPlan,
  MarketingVideoPlanType,
  MarketingVideoProfile,
  MARKETING_VIDEO_PLATFORM_TARGETS,
  PlatformMarketingOptimization,
...
export class MarketingVideoAnalyzer {
  ...
  buildHookOptimization(
    storyboard: StoryboardGenerationRecord,
    hookScene: SceneGenerationRecord,
    hookAudio?: AudioSynchronizationRecord
  ): HookOptimizationPlan {
  ...
  buildProductPresentation(
    storyboard: StoryboardGenerationRecord,
    productScene: SceneGenerationRecord
  ): ProductPresentationPlan {
    const mp = storyboard.marketingPlanning;
    return {
