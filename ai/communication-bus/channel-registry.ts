import { BusChannelDefinition, BusMessageType } from "./types.js";

const ALL_TYPES = Object.values(BusMessageType);

/** Framework communication channels — management only */
export const FRAMEWORK_CHANNEL_CATALOG: BusChannelDefinition[] = [
...
export class ChannelRegistry {
  private readonly channels = new Map<string, BusChannelDefinition>();
