import { ManagedModuleState, ModuleRegistryRecord } from "../module-manager/types.js";
...
export class MessageValidator {
  constructor(private readonly deps: MessageValidatorDeps) {}

  validate(message: BusMessage): BusValidationResult {
    const checks: BusValidationResult["checks"] = [];
