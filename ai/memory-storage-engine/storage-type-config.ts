...
export function getStorageTypeDefinition(type: MemoryStorageType): StorageTypeDefinition {
...
export function mapStorageTypeToFoundationCategory(type: MemoryStorageType): MemoryCategory {
