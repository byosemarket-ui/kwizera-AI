...
function dimensions(ratio: ImageGenerationRequest["aspectRatio"], resolution: ImageGenerationRequest["resolution"]): [number, number] {
  if (resolution === "high") return ratio === "16:9" ? [2048, 1152] : ratio === "9:16" ? [1152, 2048] : ratio === "4:5" ? [1638, 2048] : [2048, 2048];
  return ratio === "16:9" ? [1280, 720] : ratio === "9:16" ? [720, 1280] : ratio === "4:5" ? [864, 1080] : [1080, 1080];
}
