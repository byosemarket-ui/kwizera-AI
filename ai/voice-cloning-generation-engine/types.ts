...
export const ALL_VC_PLATFORMS: VcPlatform[] = [
  VcPlatform.Website,
...
export const SUPPORTED_VC_LANGUAGES: VcLanguage[] = [
  VcLanguage.English,
...
export const VOICE_LIBRARY_TYPES: VoiceLibraryType[] = [
...
export const PLATFORM_VC_CONFIG: Record<
  VcPlatform,
