...
export interface AiModel { id: string; name: string; category: AiModelCategory; version: string; description: string; status: ModelStatus; sourcePath?: string; artifactPath?: string; checksum?: string; installedAt?: string; loadedAt?: string; runtimeProviderId?: string; lastValidatedAt?: string; health: "healthy" | "warning" | "unhealthy"; requirements: ModelResourceRequirements; capabilities: string[]; usageCount: number; lastUsedAt?: string; }
