import { CandidateSolution, DecisionRequest, DecisionType } from "./types.js";

const WORKFLOW_MAP: Partial<Record<DecisionType, string>> = {
...
const MODULE_MAP: Partial<Record<DecisionType, string[]>> = {
...
export class SolutionGenerator {
  generate(request: DecisionRequest, count = 3): CandidateSolution[] {
    const workflowId =
      WORKFLOW_MAP[request.type] ?? "workflow-general";
    const modules =
