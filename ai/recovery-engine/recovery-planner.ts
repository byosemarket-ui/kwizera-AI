...
import { FailureReport, RecoveryPlan, RecoveryType, RECOVERY_SEQUENCE } from "./types.js";

export class RecoveryPlanner {
  createPlan(failure: FailureReport): RecoveryPlan {
  ...
  private mapFailureToRecoveryType(failure: FailureReport): RecoveryType {
