...
export function mapDecisionTypeToPlanningType(type: DecisionType): PlanningType {
  const map: Record<DecisionType, PlanningType> = {
...
const MODULES_BY_TYPE: Partial<Record<PlanningType, string[]>> = {
