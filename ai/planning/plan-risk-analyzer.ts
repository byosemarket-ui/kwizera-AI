import { ApprovedDecisionInput, PlanRiskAnalysis, PlanningType } from "./types.js";

export class PlanRiskAnalyzer {
  analyze(input: ApprovedDecisionInput): PlanRiskAnalysis {
    const risks: string[] = [];
    ...
    if (
      (input.planningType === PlanningType.PromotionalVideoProduction ||
