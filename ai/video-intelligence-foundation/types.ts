...
export enum VideoIntelligenceLifecycleState {
...
export enum VideoIntelligenceCategory {
...
export enum VideoIntelligenceModuleStatus {
  Prepared = "prepared",
...
export enum VideoIntelligenceHealthLevel {
  Excellent = "excellent",
  Good = "good",
  Warning = "warning",
  Critical = "critical",
...
export enum VideoIntelligenceSource {
...
export enum VideoIntelligenceVerificationStatus {
...
export enum VideoIntelligenceAccessPermission {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
...
export enum VideoIntelligenceAccessOperation {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
...
export enum VideoWorkflowActionType {
  Edit = "edit",
  Trim = "trim",
  Overlay = "overlay",
  AudioMix = "audio-mix",
