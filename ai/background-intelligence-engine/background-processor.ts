...
export class BackgroundProcessor {
  constructor(
    ...
    private readonly scorer: BackgroundScorer,
    private readonly linker: BackgroundLinker,
    private readonly records: BackgroundIntelligenceRecordStore,
    private readonly logger: BackgroundLogger
  ) {}

  async analyze(input: BackgroundIntelligenceInput): Promise<BackgroundIntelligenceResult> {
    ...
    const draft: BackgroundIntelligenceRecord = {
      imageId: input.imageId,
      backgroundId,
