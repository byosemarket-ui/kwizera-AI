...
export const ANIMATION_PLATFORM_TARGETS: StoryboardGenerationPlatform[] = [
...
export const PLATFORM_ANIMATION_CONFIG: Record<
  StoryboardGenerationPlatform,
  { pacingStyle: string; animationIntensity: string }
> = {
