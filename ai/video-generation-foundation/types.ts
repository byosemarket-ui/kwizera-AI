...
export enum VideoGenerationLifecycleState {
...
export enum VideoGenerationCategory {
...
export enum VideoGenerationModuleStatus {
  Prepared = "prepared",
...
export enum VideoGenerationHealthLevel {
  Excellent = "excellent",
  Good = "good",
  Warning = "warning",
  Critical = "critical",
...
export enum VideoGenerationVerificationStatus {
...
export enum VideoGenerationAccessPermission {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
...
export enum VideoGenerationAccessOperation {
  Read = "read",
  Write = "write",
  Update = "update",
  Delete = "delete",
...
export enum GenerationAssetType {
  Storyboard = "storyboard",
  Script = "script",
  Scene = "scene",
  Timeline = "timeline",
...
export enum GenerationBlueprintStage {
  StoryGeneration = "story-generation",
  SceneGeneration = "scene-generation",
  ShotGeneration = "shot-generation",
...
export enum GenerationWorkflowActionType {
  Generate = "generate",
  Edit = "edit",
  Replace = "replace",
  Sync = "sync",
...
export enum GenerationPlatformTarget {
  YouTube = "youtube",
  Instagram = "instagram",
  TikTok = "tiktok",
  Facebook = "facebook",
