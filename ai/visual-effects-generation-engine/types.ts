...
export enum VisualEffectPlanType {
  Lighting = "lighting",
...
export const VFX_PLATFORM_TARGETS: StoryboardGenerationPlatform[] = [
...
export const PLATFORM_VFX_CONFIG: Record<
  StoryboardGenerationPlatform,
  { effectIntensity: string; renderComplexity: string }
> = {
