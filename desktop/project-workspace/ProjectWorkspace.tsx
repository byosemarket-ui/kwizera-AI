...
export function ProjectWorkspace({ mediaOnly = false }: { mediaOnly?: boolean }) {
  ...
  return <div className="project-workspace">
    ...
    <section className="asset-browser" onDragOver={(event) => { event.preventDefault(); setDragging(true); }} onDragLeave={() => setDragging(false)} onDrop={(event: DragEvent) => { event.preventDefault(); setDragging(false); }}>
      ...
      {dragging && <div className="drop-zone">Drop files to prepare an asset import</div>}
