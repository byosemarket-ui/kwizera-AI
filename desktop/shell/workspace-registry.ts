...
export const workspaceNav: WorkspaceNavItem[] = [
  ...
  { id: "service-product-marketing-video", label: "Product Marketing Video", group: "projects", groupLabel: "Projects", keywords: ["product marketing", "marketing video", "customer", "service workspace"], inSidebar: false },
...
export const workspaceTiers: Record<WorkspaceId, WorkspaceTier> = {
  ...
  "service-product-marketing-video": "live",
