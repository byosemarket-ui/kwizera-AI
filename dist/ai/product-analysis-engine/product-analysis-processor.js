...
import { ProductAnalysisCategory, } from "./types.js";
const CATEGORY_MAP = {
...
export class ProductAnalysisProcessor {
    ...
    async analyze(input) {
        ...
        const scores = this.scorer.computeScores(analysis.profile, analysis.visual, analysis.classification, analysis.marketingPreparation, missingFields);
...
//# sourceMappingURL=product-analysis-processor.js.map