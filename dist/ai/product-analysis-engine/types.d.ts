 ...
 */
export declare enum ProductAnalysisIndustry {
...
export declare enum ProductAnalysisCategory {
...
export declare enum ProductBusinessType {
    B2C = "b2c",
    B2B = "b2b",
    D2C = "d2c",
...
export declare enum ProductAvailabilityStatus {
    InStock = "in-stock",
    PreOrder = "pre-order",
...
export declare class ProductAnalysisEngineError extends Error {
