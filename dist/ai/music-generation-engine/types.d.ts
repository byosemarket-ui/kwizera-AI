...
export declare enum MusicInputType {
...
export declare enum SyncTarget {
    Video = "video",
    Animation = "animation",
...
export declare class MusicGenerationEngineError extends Error {
    readonly code: string;
    constructor(message: string, code: string);
}
export declare const ALL_MUSIC_PLATFORMS: MusicPlatform[];
export declare const SUPPORTED_MUSIC_GENRES: MusicGenre[];
export declare const SUPPORTED_MUSIC_MOODS: MusicMood[];
export declare const PLATFORM_MUSIC_CONFIG: Record<MusicPlatform, {
