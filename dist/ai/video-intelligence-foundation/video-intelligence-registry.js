...
import { VideoIntelligenceHealthLevel, VideoIntelligenceModuleStatus, } from "./types.js";
import { DEFAULT_MODULE_STATUS, PREPARED_VIDEO_INTELLIGENCE_MODULES, } from "./video-intelligence-categories.js";
...
export class VideoIntelligenceRegistry {
    ...
    getRegisteredCount() {
        return [...this.modules.values()].filter((m) => m.status === VideoIntelligenceModuleStatus.Registered ||
            m.status === VideoIntelligenceModuleStatus.Active).length;
    }
...
//# sourceMappingURL=video-intelligence-registry.js.map