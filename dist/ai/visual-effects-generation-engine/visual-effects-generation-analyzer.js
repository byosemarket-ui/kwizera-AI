...
import { VisualEffectPlanType, VFX_PLATFORM_TARGETS, PLATFORM_VFX_CONFIG, } from "./types.js";
import { StoryboardGenerationPlatform } from "../story-generation-engine/types.js";
export class VisualEffectsGenerationAnalyzer {
    buildVisualEffectPlan(scene, cameraPlan, motionPlan, animationPlan, version) {
    ...
    buildProfile(scene, cameraPlan, motionPlan, animationPlan, version) {
        return {
    ...
    buildLightingEffects(scene, cameraPlan, isHero) {
    ...
    buildAtmosphericEffects(scene, motionPlan, animationPlan) {
    ...
    buildProductEffects(scene, animationPlan, isProduct) {
    ...
    buildEnvironmentEffects(scene, motionPlan, animationPlan) {
        const env = animationPlan.environmentAnimation;
        const em = motionPlan.environmentMotion;
        return {
    ...
    buildTransitionEffects(scene, animationPlan) {
    ...
    buildTextGraphicEffects(scene, animationPlan) {
    ...
    buildCinematicEffects(scene, cameraPlan) {
    ...
    buildSynchronization(scene, cameraPlan, motionPlan, animationPlan) {
        return {
...
//# sourceMappingURL=visual-effects-generation-analyzer.js.map