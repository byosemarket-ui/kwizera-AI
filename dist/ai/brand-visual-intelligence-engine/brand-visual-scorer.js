export class BrandVisualScorer {
    computeScores(consistency, logo) {
        const brandConsistencyScore = Math.round((consistency.logoConsistency +
    ...
    isAnalysisValid(scores, brandName, consistency) {
        const diagnostics = [];
...
//# sourceMappingURL=brand-visual-scorer.js.map