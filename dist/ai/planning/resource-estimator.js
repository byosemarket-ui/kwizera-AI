...
export class ResourceEstimator {
    estimate(type, tasks, moduleIds) {
        ...
        const cpuIntensity = type === "promotional-video-production" || type === "video-enhancement"
            ? "high"
            : type === "export"
                ? "medium"
                : "low";
...
//# sourceMappingURL=resource-estimator.js.map