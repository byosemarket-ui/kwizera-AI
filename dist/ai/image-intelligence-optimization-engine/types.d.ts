...
export type ImageOptimizationStrategyType = "relationship" | "classification" | "search" | "knowledge-retrieval" | "recommendation" | "workflow" | "performance" | "cache" | "metadata";
...
export declare class ImageIntelligenceOptimizationEngineError extends Error {
