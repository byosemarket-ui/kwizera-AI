...
export declare enum CharacterMotionAction {
    Walking = "walking",
    Running = "running",
    Turning = "turning",
    Looking = "looking",
...
export declare enum ProductMotionAction {
    Rotation = "rotation",
    Reveal = "reveal",
...
export declare enum ObjectMotionAction {
    Entry = "entry",
    Exit = "exit",
    Interaction = "interaction",
...
export declare enum EnvironmentMotionType {
    Wind = "wind",
    Rain = "rain",
    Smoke = "smoke",
    Fire = "fire",
...
export declare class MotionGenerationEngineError extends Error {
    readonly code: string;
    constructor(message: string, code: string);
}
export declare const MOTION_PLATFORM_TARGETS: StoryboardGenerationPlatform[];
export declare const PLATFORM_MOTION_CONFIG: Record<StoryboardGenerationPlatform, {
    pacingStyle: string;
    movementIntensity: string;
}>;
