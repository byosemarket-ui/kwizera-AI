...
export declare enum QualityValidationType {
    Standard = "standard",
...
export declare class VideoQualityValidationEngineError extends Error {
    readonly code: string;
    constructor(message: string, code: string);
}
export declare const QUALITY_PLATFORM_TARGETS: StoryboardGenerationPlatform[];
export declare const PLATFORM_QUALITY_CONFIG: Record<StoryboardGenerationPlatform, {
    resolution: string;
    aspectRatio: string;
    maxDuration: string;
}>;
