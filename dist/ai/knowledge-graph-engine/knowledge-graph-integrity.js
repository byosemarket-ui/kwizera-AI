import { GraphValidationStatus, KnowledgeRelationType, } from "./types.js";
export class KnowledgeGraphIntegrityValidator {
    ...
    detectDependencyCycles() {
        const cycles = [];
        const depEdges = this.graph.getAllEdges().filter((e) => e.relationshipType === KnowledgeRelationType.DependsOn ||
...
//# sourceMappingURL=knowledge-graph-integrity.js.map