 ...
 */
export declare enum SfxPlatform {
    Website = "website",
    Mobile = "mobile",
    YouTube = "youtube",
    TikTok = "tiktok",
...
export declare enum SfxInputType {
...
export declare enum SfxSyncTarget {
    Video = "video",
    Animation = "animation",
    Game = "game",
    Film = "film",
...
export declare enum CinematicType {
    Impact = "impact",
    Boom = "boom",
    Whoosh = "whoosh",
    Rise = "rise",
...
export declare class SoundEffectsGenerationEngineError extends Error {
    readonly code: string;
    constructor(message: string, code: string);
}
export declare const ALL_SFX_PLATFORMS: SfxPlatform[];
export declare const SUPPORTED_SOUND_CATEGORIES: SoundCategory[];
export declare const FOLEY_TYPES: FoleyType[];
export declare const ENVIRONMENTAL_TYPES: EnvironmentalType[];
export declare const CINEMATIC_TYPES: CinematicType[];
export declare const PLATFORM_SFX_CONFIG: Record<SfxPlatform, {
