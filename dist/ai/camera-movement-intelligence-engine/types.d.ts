 ...
 */
export declare enum CameraMovementType {
    Static = "static",
    Pan = "pan",
    Tilt = "tilt",
    ZoomIn = "zoom-in",
...
export declare enum ShotFraming {
...
export declare enum CameraStabilityLevel {
    Stable = "stable",
    SlightShake = "slight-shake",
    HeavyShake = "heavy-shake"
}
export declare enum CinematicPurpose {
...
export declare class CameraMovementEngineError extends Error {
