...
export class ProductIntelligenceAuditor {
    ...
    async runAudit() {
        ...
        const planningIntegrity = scriptReport.readinessScore >= 75 &&
        ...
        const marketingConsistency = strategyReport.readinessScore >= 75 &&
        ...
        const brandConsistency = understandingReport.readinessScore >= 75 &&
        ...
        const optimizationStatus = this.foundation.getProductIntelligenceOptimizationEngine().buildStatusReport().readinessScore >= 75;
...
//# sourceMappingURL=product-intelligence-auditor.js.map