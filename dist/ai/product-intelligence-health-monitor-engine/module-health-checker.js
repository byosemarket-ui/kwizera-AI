import { MonitoredProductIntelligenceModule, ProductIntelligenceHealthScoreLevel, } from "./types.js";
export class ProductIntelligenceModuleHealthChecker {
    ...
    checkAll() {
        const scores = [];
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.ProductIntelligenceFoundation, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.ProductAnalysis, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.ProductUnderstanding, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.AudienceIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.MarketingStrategy, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.CreativeDirection, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.StoryboardIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.ScriptPlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.VisualPlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.AudioPlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.ProductionPlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.QualityPrediction, () => {
        ...
        scores.push(this.checkModule(MonitoredProductIntelligenceModule.ProductIntelligenceOptimization, () => {
        ...
        const relationshipScore = Math.min(100, 70 + (qpReport.predictionsPrepared > 0 ? 15 : 0) + (qpReport.averageOverallQualityScore >= 55 ? 15 : 0));
        scores.push({
    ...
    scoreToLevel(score) {
        if (score >= 95)
            return ProductIntelligenceHealthScoreLevel.Excellent;
        if (score >= 80)
            return ProductIntelligenceHealthScoreLevel.Good;
        if (score >= 60)
            return ProductIntelligenceHealthScoreLevel.Warning;
        if (score >= 40)
            return ProductIntelligenceHealthScoreLevel.Critical;
