 ...
 */
export declare enum ProductIntelligenceHealthScoreLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum MonitoredProductIntelligenceModule {
...
export declare enum ProductIntelligenceWarningType {
...
export declare class ProductIntelligenceHealthMonitorEngineError extends Error {
