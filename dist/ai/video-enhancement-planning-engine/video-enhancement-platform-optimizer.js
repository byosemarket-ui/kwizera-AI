import { VideoEnhancementPlatform } from "./types.js";
...
export class VideoEnhancementPlatformOptimizer {
    buildPlatformRules(primaryPlatform, videoType, orientation) {
    ...
    priorityFor(platform, primary, videoType) {
        if (platform === primary)
            return "high";
        if (videoType === VideoAnalysisType.SocialMedia) {
            if (platform === VideoEnhancementPlatform.Instagram ||
                platform === VideoEnhancementPlatform.TikTok ||
                platform === VideoEnhancementPlatform.Facebook) {
                return "medium";
            }
...
//# sourceMappingURL=video-enhancement-platform-optimizer.js.map