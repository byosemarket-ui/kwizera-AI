...
export interface ProductPattern {
    patternId: string;
    patternType: "product-layout" | "product-image" | "product-video" | "marketing-structure" | "sales-message" | "branding-style";
    description: string;
...
export declare class ProductMemoryEngineError extends Error {
