import { KnowledgeHealthScoreLevel, MonitoredKnowledgeModule, } from "./types.js";
export class KnowledgeModuleHealthChecker {
    ...
    scoreToLevel(score) {
        if (score >= 95)
            return KnowledgeHealthScoreLevel.Excellent;
        if (score >= 80)
            return KnowledgeHealthScoreLevel.Good;
        if (score >= 60)
            return KnowledgeHealthScoreLevel.Warning;
        if (score >= 40)
            return KnowledgeHealthScoreLevel.Critical;
