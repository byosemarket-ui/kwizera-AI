 ...
 */
export declare enum KnowledgeHealthScoreLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum MonitoredKnowledgeModule {
...
export declare enum KnowledgeWarningType {
...
export declare class KnowledgeHealthMonitorEngineError extends Error {
