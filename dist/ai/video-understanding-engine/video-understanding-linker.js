export class VideoUnderstandingLinker {
    detectRelationships(record, allRecords, analysis, projects = [], knowledgeIds = [], storyboards = [], scripts = [], creativePlans = []) {
        const relatedVideos = [];
        const relatedBrands = [
        ...
        for (const other of allRecords) {
            ...
            else if (other.product.mainProduct === record.product.mainProduct &&
...
//# sourceMappingURL=video-understanding-linker.js.map