 ...
 */
export declare enum VideoUnderstandingMarketingGoal {
...
export declare enum VideoStoryType {
...
export declare enum VideoSceneRole {
    Opening = "opening",
    Hook = "hook",
...
export declare class VideoUnderstandingEngineError extends Error {
