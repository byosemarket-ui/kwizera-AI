...
export declare enum KnowledgeStorageType {
...
export declare enum KnowledgeRecordStatus {
    Active = "active",
    Pending = "pending",
    Verified = "verified",
    Archived = "archived",
...
export declare enum KnowledgeIntegrityStatus {
    Verified = "verified",
    Unverified = "unverified",
    Corrupted = "corrupted",
    PendingVerification = "pending-verification"
}
export declare enum KnowledgeStorageValidationCode {
...
export declare class KnowledgeStorageEngineError extends Error {
