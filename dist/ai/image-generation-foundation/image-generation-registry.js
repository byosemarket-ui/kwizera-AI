...
import { ImageGenerationHealthLevel, ImageGenerationModuleStatus, } from "./types.js";
import { DEFAULT_MODULE_STATUS, PREPARED_IMAGE_GENERATION_MODULES, } from "./image-generation-categories.js";
...
export class ImageGenerationRegistry {
    ...
    getRegisteredCount() {
        return [...this.modules.values()].filter((m) => m.status === ImageGenerationModuleStatus.Registered ||
            m.status === ImageGenerationModuleStatus.Active).length;
    }
...
//# sourceMappingURL=image-generation-registry.js.map