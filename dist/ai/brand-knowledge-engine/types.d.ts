 ...
 */
export declare enum KnowledgeBrandIndustry {
...
export declare enum BrandMarketingStyle {
    Premium = "premium",
    Playful = "playful",
...
export interface BrandKnowledgeRecommendation {
    category: "branding" | "logo-placement" | "color-usage" | "typography" | "storytelling" | "marketing-alignment" | "consistency";
    suggestion: string;
...
export interface BrandKnowledgeLearningPattern {
    patternId: string;
    patternType: "identity" | "visual" | "communication" | "consistency" | "campaign" | "presentation";
    description: string;
...
export declare class BrandKnowledgeEngineError extends Error {
