...
import { ProductIntelligenceHealthLevel, ProductIntelligenceModuleStatus, } from "./types.js";
import { DEFAULT_MODULE_STATUS, PREPARED_PRODUCT_INTELLIGENCE_MODULES, } from "./product-intelligence-categories.js";
...
export class ProductIntelligenceRegistry {
    ...
    getRegisteredCount() {
        return [...this.modules.values()].filter((m) => m.status === ProductIntelligenceModuleStatus.Registered ||
            m.status === ProductIntelligenceModuleStatus.Active).length;
    }
...
//# sourceMappingURL=product-intelligence-registry.js.map