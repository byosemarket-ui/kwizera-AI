 ...
 */
export declare enum ProductIntelligenceLifecycleState {
...
export declare enum ProductIntelligenceCategory {
...
export declare enum ProductIntelligenceModuleStatus {
    Prepared = "prepared",
...
export declare enum ProductIntelligenceHealthLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum ProductIntelligenceSource {
...
export declare enum ProductIntelligenceVerificationStatus {
...
export declare enum ProductIntelligenceAccessPermission {
    Read = "read",
    Write = "write",
    Update = "update",
    Delete = "delete",
...
export declare enum ProductIntelligenceAccessOperation {
    Read = "read",
    Write = "write",
    Update = "update",
    Delete = "delete",
...
export declare class ProductIntelligenceFoundationError extends Error {
