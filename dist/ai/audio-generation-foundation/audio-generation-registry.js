...
import { AudioGenerationHealthLevel, AudioGenerationModuleStatus, } from "./types.js";
import { DEFAULT_MODULE_STATUS, PREPARED_AUDIO_GENERATION_MODULES, } from "./audio-generation-categories.js";
...
export class AudioGenerationRegistry {
    ...
    getRegisteredCount() {
        return [...this.modules.values()].filter((m) => m.status === AudioGenerationModuleStatus.Registered ||
            m.status === AudioGenerationModuleStatus.Active).length;
    }
...
//# sourceMappingURL=audio-generation-registry.js.map