...
import { AudioGenerationHealthLevel } from "./types.js";
...
export class AudioGenerationHealthMonitor {
    ...
    scoreToLevel(score) {
        if (score >= 95)
            return AudioGenerationHealthLevel.Excellent;
        if (score >= 80)
            return AudioGenerationHealthLevel.Good;
        if (score >= 60)
            return AudioGenerationHealthLevel.Warning;
        if (score >= 40)
            return AudioGenerationHealthLevel.Critical;
...
//# sourceMappingURL=audio-generation-health-monitor.js.map