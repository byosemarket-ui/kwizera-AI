 ...
 */
export declare enum AudioGenerationLifecycleState {
...
export declare enum AudioGenerationCategory {
...
export declare enum AudioGenerationModuleStatus {
    Prepared = "prepared",
...
export declare enum AudioGenerationHealthLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum AudioGenerationSource {
...
export declare enum AudioGenerationVerificationStatus {
...
export declare enum AudioGenerationAccessPermission {
    Read = "read",
    Write = "write",
    Update = "update",
    Delete = "delete",
...
export declare enum AudioGenerationAccessOperation {
    Read = "read",
    Write = "write",
    Update = "update",
    Delete = "delete",
...
export declare enum AudioGenerationAssetType {
    Prompt = "prompt",
    Voice = "voice",
...
export declare enum AudioGenerationBlueprintStage {
...
export declare enum AudioGenerationWorkflowActionType {
    Generate = "generate",
    Edit = "edit",
    Replace = "replace",
    Sync = "sync",
...
export declare enum AudioGenerationPlatformTarget {
    Podcast = "podcast",
    Spotify = "spotify",
    YouTube = "youtube",
    Social = "social",
...
export declare enum AudioGenerationQualityTarget {
    Low = "low",
    Standard = "standard",
    High = "high",
    Studio = "studio",
...
export declare class AudioGenerationFoundationError extends Error {
