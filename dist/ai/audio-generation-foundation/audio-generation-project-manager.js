...
export class GenerationProjectManager {
    ...
    registerTrack(projectId, trackId) {
    ...
    registerVoice(projectId, voiceId) {
        const project = this.projects.get(projectId);
        if (!project)
            return null;
    ...
    registerSpeaker(projectId, speakerId) {
        const project = this.projects.get(projectId);
        if (!project)
            return null;
    ...
    searchProjects(query) {
        ...
        if (query.quality)
            results = results.filter((p) => p.qualities.includes(query.quality));
...
//# sourceMappingURL=audio-generation-project-manager.js.map