import { KnowledgeCampaignType, } from "./types.js";
...
export class MarketingRelationshipLinker {
    detectSimilar(record, allRecords) {
        ...
        for (const other of allRecords) {
            if (other.campaignId === record.campaignId)
                continue;
    ...
    similarityScore(a, b) {
        ...
        if (a.productName === b.productName && a.productName)
            score += 25;
        if (a.marketingGoal === b.marketingGoal)
            score += 15;
        if (a.campaign.marketingStyle === b.campaign.marketingStyle)
            score += 15;
...
//# sourceMappingURL=marketing-recommender.js.map