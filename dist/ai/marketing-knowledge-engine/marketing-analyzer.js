import { KnowledgeCampaignType, KnowledgeMarketingGoal, KnowledgeMarketingPlatform, MarketingStyle, } from "./types.js";
export class MarketingAnalyzer {
    analyze(input) {
        ...
        const positioning = {
            productName: product,
            valueProposition: input.positioning?.valueProposition ?? "AI-powered creative production for professionals",
            uniqueSellingPoints: input.positioning?.uniqueSellingPoints ?? [
                "automated workflows",
                "brand consistency",
                "multi-platform output",
            ],
            competitiveAdvantage: input.positioning?.competitiveAdvantage ?? "integrated knowledge-driven AI studio",
            targetSegment: input.positioning?.targetSegment ?? input.audience ?? "creative professionals",
            positioningStatement: input.positioning?.positioningStatement ??
        ...
        const campaign = {
            campaignObjective: input.campaign?.campaignObjective ?? input.marketingGoal ?? KnowledgeMarketingGoal.Conversion,
...
//# sourceMappingURL=marketing-analyzer.js.map