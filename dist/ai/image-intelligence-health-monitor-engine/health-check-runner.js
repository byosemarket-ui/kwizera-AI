...
export class ImageIntelligenceHealthCheckRunner {
    ...
    async runCheck() {
        ...
        if (overallLevel === ImageIntelligenceHealthScoreLevel.Critical ||
        ...
        const qualityPredictionStatus = this.foundation.getImageQualityPredictionEngine().buildStatusReport().readinessScore >= 75;
        ...
        const imageQualityIntegrity = qpReport.readinessScore >= 75 &&
