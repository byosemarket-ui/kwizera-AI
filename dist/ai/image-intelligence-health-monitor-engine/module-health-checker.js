import { ImageIntelligenceHealthScoreLevel, MonitoredImageIntelligenceModule, } from "./types.js";
export class ImageIntelligenceModuleHealthChecker {
    ...
    checkAll() {
        const scores = [];
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ImageIntelligenceFoundation, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ImageAnalysis, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ImageUnderstanding, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ObjectDetection, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.BackgroundIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.CompositionIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.LightingColorIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.BrandVisualIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ImageEnhancementPlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.CreativeImageIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ProductionImagePlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ImageQualityPrediction, () => {
        ...
        scores.push(this.checkModule(MonitoredImageIntelligenceModule.ImageIntelligenceOptimization, () => {
        ...
        const relationshipScore = Math.min(100, 70 + (qpReport.predictionsCreated > 0 ? 15 : 0) + (qpReport.averageOverallQualityScore >= 55 ? 15 : 0));
        scores.push({
    ...
    scoreToLevel(score) {
        if (score >= 95)
            return ImageIntelligenceHealthScoreLevel.Excellent;
        if (score >= 80)
            return ImageIntelligenceHealthScoreLevel.Good;
        if (score >= 60)
            return ImageIntelligenceHealthScoreLevel.Warning;
        if (score >= 40)
            return ImageIntelligenceHealthScoreLevel.Critical;
