...
export class ScriptPlanningAnalyzer {
    buildProfile(input, storyboard, version, language) {
    ...
    buildScriptStructure(storyboard) {
    ...
    buildScenePlans(storyboard, understanding, creative, language) {
    ...
    buildVoicePreparation(creative, storyboard, understanding) {
        const config = PLATFORM_SCRIPT_CONFIG[storyboard.profile.platform];
    ...
    buildSubtitlePreparation(scenePlans, storyboard) {
    ...
    validateSceneAlignment(scenePlans, storyboard) {
        const issues = [];
    ...
    buildSceneScriptPlan(scene, storyboard, understanding, creative, config, language) {
...
//# sourceMappingURL=script-planning-analyzer.js.map