 ...
 */
export declare enum VideoGenerationHealthScoreLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum MonitoredVideoGenerationModule {
...
export declare enum VideoGenerationWarningType {
...
export declare class VideoGenerationHealthMonitorEngineError extends Error {
