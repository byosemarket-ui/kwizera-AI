...
export class ImageGenerationModuleHealthChecker {
    ...
    checkAll() {
        const scores = [];
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageGenerationFoundation, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.TextToImageGeneration, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageToImageGeneration, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ProductImageGeneration, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.BackgroundGeneration, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageEditing, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageEnhancement, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.BrandingDesign, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.MultiStyleImageGeneration, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageProduction, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageRenderingPreparation, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageQualityValidation, () => {
        ...
        scores.push(this.checkModule(MonitoredImageGenerationModule.ImageGenerationOptimization, () => {
        ...
        const layerScore = renderReport.averageLayerIntegrityScore > 0 ? renderReport.averageLayerIntegrityScore : 85;
        scores.push({
        ...
        const maskScore = renderRecords.averageLayerIntegrityScore > 0 ? renderRecords.averageLayerIntegrityScore : 85;
        scores.push({
    ...
    scoreToLevel(score) {
        if (score >= 95)
            return ImageGenerationHealthScoreLevel.Excellent;
        if (score >= 80)
            return ImageGenerationHealthScoreLevel.Good;
        if (score >= 60)
            return ImageGenerationHealthScoreLevel.Warning;
        if (score >= 40)
            return ImageGenerationHealthScoreLevel.Critical;
