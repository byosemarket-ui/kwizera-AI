 ...
 */
export declare enum ImageGenerationHealthScoreLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum MonitoredImageGenerationModule {
...
export declare enum ImageGenerationWarningType {
...
export declare class ImageGenerationHealthMonitorEngineError extends Error {
