 ...
 */
export declare enum KnowledgeLifecycleState {
...
export declare enum KnowledgeModuleStatus {
    Prepared = "prepared",
...
export declare enum KnowledgeHealthLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum KnowledgeVerificationStatus {
...
export declare enum KnowledgeAccessPermission {
    Read = "read",
    Write = "write",
    Update = "update",
    Delete = "delete",
...
export declare enum KnowledgeAccessOperation {
    Read = "read",
    Write = "write",
    Update = "update",
    Delete = "delete",
...
export declare class KnowledgeFoundationError extends Error {
