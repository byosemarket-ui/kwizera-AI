...
export declare enum CompositionMarketingGoal {
...
export declare enum CompositionPlatform {
    Web = "web",
    Social = "social",
    Ecommerce = "ecommerce",
    Print = "print",
...
export declare class CompositionIntelligenceEngineError extends Error {
