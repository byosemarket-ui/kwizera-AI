...
export declare enum LightingDirection {
    Front = "front",
    Side = "side",
    Back = "back",
    Top = "top",
...
export declare enum LightingColorMarketingGoal {
...
export declare class LightingColorIntelligenceEngineError extends Error {
