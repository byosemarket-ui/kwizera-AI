...
import { VideoGenerationHealthLevel } from "./types.js";
...
export class VideoGenerationHealthMonitor {
    ...
    scoreToLevel(score) {
        if (score >= 95)
            return VideoGenerationHealthLevel.Excellent;
        if (score >= 80)
            return VideoGenerationHealthLevel.Good;
        if (score >= 60)
            return VideoGenerationHealthLevel.Warning;
        if (score >= 40)
            return VideoGenerationHealthLevel.Critical;
...
//# sourceMappingURL=video-generation-health-monitor.js.map