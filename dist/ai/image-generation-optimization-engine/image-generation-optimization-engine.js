...
import { ImageGenerationOptimizationEngineError, } from "./types.js";
/**
...
export class AiImageGenerationOptimizationEngine {
    ...
    logger = new ImageGenerationOptimizationLogger();
    records = new ImageGenerationOptimizationRecordStore();
    analyzer = new ImageGenerationOptimizationAnalyzer();
    scorer = new ImageGenerationOptimizationScorer();
    linker = new ImageGenerationOptimizationLinker();
    processor = null;
    optimizationTimes = [];
    searchTimes = [];
    repairTimes = [];
    initialize(foundation, storageRoot) {
        ...
        this.processor = new ImageGenerationOptimizationProcessor(foundation, this.analyzer, this.scorer, this.linker, this.records, this.logger);
    ...
    async repairAndReoptimize(productId, platform) {
        this.ensureReady();
    ...
    ensureReady() {
        if (!this.initialized || !this.foundation || !this.processor) {
            throw new ImageGenerationOptimizationEngineError("Image Generation Optimization Engine not initialized", "NOT_INITIALIZED");
        }
    }
}
//# sourceMappingURL=image-generation-optimization-engine.js.map