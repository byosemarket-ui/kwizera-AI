 ...
 */
export declare enum AmbientPlatform {
    Website = "website",
    Mobile = "mobile",
    YouTube = "youtube",
    TikTok = "tiktok",
...
export declare enum NatureAmbienceType {
    Forest = "forest",
    Rain = "rain",
    Wind = "wind",
    Ocean = "ocean",
...
export declare enum UrbanAmbienceType {
    City = "city",
    Traffic = "traffic",
    Market = "market",
    Airport = "airport",
...
export declare enum IndoorAmbienceType {
    Office = "office",
    Home = "home",
    Classroom = "classroom",
    Hospital = "hospital",
...
export declare enum AmbientSyncTarget {
    Video = "video",
    Animation = "animation",
    Film = "film",
    Podcast = "podcast",
...
export declare enum AmbientInputType {
...
export declare class AmbientAudioGenerationEngineError extends Error {
    readonly code: string;
    constructor(message: string, code: string);
}
export declare const ALL_AMBIENT_PLATFORMS: AmbientPlatform[];
export declare const SUPPORTED_ENVIRONMENT_CATEGORIES: EnvironmentCategory[];
export declare const NATURE_AMBIENCE_TYPES: NatureAmbienceType[];
export declare const URBAN_AMBIENCE_TYPES: UrbanAmbienceType[];
export declare const INDOOR_AMBIENCE_TYPES: IndoorAmbienceType[];
export declare const WEATHER_TYPES: WeatherType[];
export declare const PLATFORM_AMBIENT_CONFIG: Record<AmbientPlatform, {
