...
function isDependencySatisfied(foundation, dep) {
    if (EXTERNAL_VI_DEPENDENCIES.has(dep)) {
        ...
        if (dep === "product-intelligence-engine")
            return status.productIntelligenceEngine;
        if (dep === "image-intelligence-engine")
            return status.imageIntelligenceEngine;
        return true;
    }
...
export class VideoIntelligenceAuditor {
    ...
    async runAudit() {
        ...
        const videoQuality = qpReport.readinessScore >= 75 &&
...
//# sourceMappingURL=video-intelligence-auditor.js.map