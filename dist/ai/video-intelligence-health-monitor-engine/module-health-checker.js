...
export class VideoIntelligenceModuleHealthChecker {
    ...
    checkAll() {
        const scores = [];
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.VideoIntelligenceFoundation, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.VideoAnalysis, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.VideoUnderstanding, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.SceneDetection, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.TimelineIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.CameraMovement, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.MotionIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.VideoStyle, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.VideoEnhancementPlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.CreativeVideoIntelligence, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.ProductionVideoPlanning, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.VideoQualityPrediction, () => {
        ...
        scores.push(this.checkModule(MonitoredVideoIntelligenceModule.VideoIntelligenceOptimization, () => {
        ...
        const timelineScore = Math.min(100, timelineReport.readinessScore +
        ...
        scores.push({
            ...
            issues: timelineReport.averageTimelineQualityScore > 0 &&
    ...
    scoreToLevel(score) {
        if (score >= 95)
            return VideoIntelligenceHealthScoreLevel.Excellent;
        if (score >= 80)
            return VideoIntelligenceHealthScoreLevel.Good;
        if (score >= 60)
            return VideoIntelligenceHealthScoreLevel.Warning;
        if (score >= 40)
            return VideoIntelligenceHealthScoreLevel.Critical;
