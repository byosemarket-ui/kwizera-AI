 ...
 */
export declare enum VideoIntelligenceHealthScoreLevel {
    Excellent = "excellent",
    Good = "good",
    Warning = "warning",
    Critical = "critical",
...
export declare enum MonitoredVideoIntelligenceModule {
...
export declare enum VideoIntelligenceWarningType {
...
export declare class VideoIntelligenceHealthMonitorEngineError extends Error {
