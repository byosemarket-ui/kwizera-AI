 ...
 */
export declare enum BusMessageType {
    Request = "request",
    Response = "response",
    Event = "event",
...
export declare enum BusMessagePriority {
    Critical = "critical",
    High = "high",
    Normal = "normal",
    Low = "low",
...
export declare enum BusCommunicationState {
    Created = "created",
    Queued = "queued",
    Sending = "sending",
    Delivered = "delivered",
...
export declare class CommunicationBusError extends Error {
    readonly code: string;
    readonly messageId?: string | undefined;
    constructor(message: string, code: string, messageId?: string | undefined);
}
export declare const PRIORITY_ORDER: Record<BusMessagePriority, number>;
export declare const SUPPORTED_MESSAGE_TYPES: BusMessageType[];
