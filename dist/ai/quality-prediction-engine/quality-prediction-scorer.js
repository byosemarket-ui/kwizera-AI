export class QualityPredictionScorer {
    isPredictionValid(scores, checks, risks, productionPlanReady) {
        const diagnostics = [];
        ...
        if (checks.issues.length > 0)
            diagnostics.push(...checks.issues);
        if (!productionPlanReady)
            diagnostics.push("Production plan must be production-ready");
    ...
    isProductionReady(scores, risks, productionPlanReady, checks) {
...
//# sourceMappingURL=quality-prediction-scorer.js.map