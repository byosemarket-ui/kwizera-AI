 ...
 */
export declare const AI_ASSISTANT_NAME: "KWIZERA AI";
export declare const APPLICATION_NAME: "KWIZERA AI STUDIO";
/** AI Core lifecycle states per Step 2A */
export declare enum AiLifecycleState {
...
export type LogCategory = "startup" | "shutdown" | "error" | "warning" | "initialization" | "recovery" | "configuration" | "module-registration" | "lifecycle" | "health" | "session";
...
export type ModuleRegistrationStatus = "slot-reserved" | "registered" | "initialized" | "running" | "failed" | "disabled";
...
export declare class AiCoreError extends Error {
    ...
    readonly diagnostic?: AiInitializationDiagnostic | undefined;
    constructor(message: string, code: string, diagnostic?: AiInitializationDiagnostic | undefined);
}
