...
export declare enum StoryboardGenerationPlatform {
    TikTok = "tiktok",
...
export declare enum StoryboardGenerationInputType {
...
export declare enum StoryboardStoryType {
...
export declare class StoryboardGenerationEngineError extends Error {
    readonly code: string;
    constructor(message: string, code: string);
}
/** Map CreativePlatform to StoryboardGenerationPlatform */
export declare function mapCreativePlatform(platform: CreativePlatform): StoryboardGenerationPlatform;
export declare const ALL_STORYBOARD_PLATFORMS: StoryboardGenerationPlatform[];
export declare const PLATFORM_CONFIG: Record<StoryboardGenerationPlatform, {
    sceneCount: number;
    totalSeconds: number;
    aspectRatio: string;
}>;
