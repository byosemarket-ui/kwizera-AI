...
import { KnowledgeOptimizationStrategy, } from "./types.js";
export class KnowledgeOptimizer {
    ...
    logger;
    snapshotFiles;
    constructor(foundation, analyzer, tierManager, deduplicator, metadataOptimizer, qualityImprover, cacheOptimizer, recoveryManager, logger, snapshotFiles) {
        this.foundation = foundation;
        this.analyzer = analyzer;
        this.tierManager = tierManager;
        this.deduplicator = deduplicator;
        this.metadataOptimizer = metadataOptimizer;
        this.qualityImprover = qualityImprover;
    ...
    async runFullOptimization() {
        ...
        try {
            ...
            steps.push(await this.runStep(KnowledgeOptimizationStrategy.Graph, () => {
            ...
            steps.push(await this.runStep(KnowledgeOptimizationStrategy.Metadata, async () => {
            ...
            steps.push(await this.runStep(KnowledgeOptimizationStrategy.Semantic, async () => {
            ...
            steps.push(await this.runStep(KnowledgeOptimizationStrategy.Deduplication, async () => {
            ...
            steps.push(await this.runStep(KnowledgeOptimizationStrategy.Recommendation, () => {
            ...
            steps.push(await this.runStep(KnowledgeOptimizationStrategy.Cache, async () => {
            ...
            steps.push(await this.runStep(KnowledgeOptimizationStrategy.Search, async () => {
    ...
    async verifyIntegrity() {
        ...
        if (!graphValid)
            diagnostics.push("Graph integrity issues detected");
        if (!searchQualityMaintained)
            diagnostics.push("Search quality degraded");
        if (!recommendationQualityMaintained)
            diagnostics.push("Recommendation quality below threshold");
        return {
            valid: recordsIntact &&
                indexesValid &&
                relationshipsValid &&
...
//# sourceMappingURL=knowledge-optimizer.js.map