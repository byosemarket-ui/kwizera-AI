 ...
 */
export declare enum CreativeVideoPlatform {
    TikTok = "tiktok",
...
export declare enum CreativeVideoTemplateType {
...
export declare enum CreativeVideoType {
...
export declare class CreativeVideoIntelligenceEngineError extends Error {
