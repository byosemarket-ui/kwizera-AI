...
export const RECOVERY_PATH_PREFIXES = {
...
export function resolveRestoreMode(type) {
    switch (type) {
...
export function resolveRecoveredComponents(type) {
    const map = {
...
//# sourceMappingURL=partial-recovery-handler.js.map