...
import { ImageAnalysisEngineError, ImageFileFormat, ImageAnalysisType, ImageColorSpace, ImageCompressionType, } from "./types.js";
/**
...
export class AiImageAnalysisEngine {
    ...
    logger = new ImageAnalysisLogger();
    records = new ImageAnalysisRecordStore();
    analyzer = new ImageAnalysisAnalyzer();
    completeness = new ImageAnalysisCompletenessDetector();
    scorer = new ImageAnalysisScorer();
    linker = new ImageAnalysisLinker();
    processor = null;
    analysisTimes = [];
    searchTimes = [];
    classificationTimes = [];
    initialize(foundation, storageRoot) {
        ...
        this.processor = new ImageAnalysisProcessor(foundation, this.analyzer, this.completeness, this.scorer, this.linker, this.records, this.logger);
    ...
    buildStatusReport() {
        ...
        return {
            ...
            classificationStatus: "product, lifestyle, marketing, logo, banner, poster, screenshot, background classification active",
            relationshipStatus: `${all.length} images indexed for relationship detection`,
            completenessStatus: "image completeness, technical quality, visual quality, and confidence scoring active",
...
//# sourceMappingURL=image-analysis-engine.js.map